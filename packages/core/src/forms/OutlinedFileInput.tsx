...
export const OutlinedFileInput = forwardRef<TextInput, OutlinedFieldInputProps>((props, ref) => {
...
OutlinedFileInput.defaultProps = {
    editable: true,
    error: false,
    disabled: false,
}
...
const ErrorText = themed(Typography, ({ ds, resolve, error, disabled }) => ({
    marginTop: rv(4),
    paddingHorizontal: resolve(ds.comp.outlinedTextInput.containerPaddingHorizontal),
...
const UploadText = themed(Typography, ({ ds, resolve, error, disabled }) => ({
    minHeight: resolve(resolve(ds.comp.outlinedTextInput.supportingTextTypeScale).lineHeight),
    color: resolve(ds.comp.outlinedTextInput.supportingTextColor),
    ...(disabled ? {
        color: rgba(
...
export interface OutlinedFieldInputProps {
    value?: string,
    defaultValue?: string
    disabled?: boolean
    editable?: boolean
